...
public class SMSGUI extends JFrame {
	...
	public SMSGUI() {
		...
		txtJeeMainRoll.setText("JEE MAIN ROLL NO");
		...
		btnNewButton_1 = new JButton("ADD STUDENT");
		btnNewButton_1.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
		btnNewButton_1.setBounds(1577, 597, 194, 57);
